...
def get_fcresnet_config(max_num_layers=2, max_num_res_blocks=17):
...
def get_fixed_fcresnet_config(num_layers_block=2, num_blocks=17):
    ...
    num_res_blocks = ConfigSpace.Constant(
        'num_res_blocks',
        num_blocks
    )
    res_block_type = ConfigSpace.Constant(
...
def get_fixed_fc_config(max_nr_layers=34):
...
def get_fixed_fc_config_no_reg(max_nr_layers=34):
    ...
    activate_dropout = ConfigSpace.Constant(
        'activate_dropout',
        'No'
    )
    cs.add_hyperparameter(activate_dropout)
